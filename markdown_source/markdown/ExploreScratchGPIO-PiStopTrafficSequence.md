...
<!---#ifdef ALT_LINK--->
<!---
> <a href="FILE_SRC/Discover-PiStop.FILE_SRC_EXT">**Discover: The Pi-Stop**</a>: For more information about Pi-Stop and how to use it.
>  
> <a href="FILE_SRC/Setup-ScratchGPIO.FILE_SRC_EXT">**Setup: Scratch GPIO**</a>: For instructions on how to setup Scratch GPIO with Pi-Stop *(which is needed for this section)*.
>
> <a href="FILE_SRC/ExploreScratchGPIO-PiStopTrafficSequence.FILE_SRC_EXT">**Explore and Challenge Scratch GPIO: Pi-Stop First Steps**</a>: If you've not used Scratch before, this will provide a quick introduction to building your first Scratch GPIO program.
--->
<!---#else--->
...
<a href="FILE_SRC/ExploreScratchGPIO-PiStopFirstSteps.FILE_SRC_EXT">**Explore and Challenge Scratch GPIO: Pi-Stop First Steps**</a> which introduced them for the first time.
--->
<!---#else--->
...
<!---#ifdef ALT_LINK--->
<!---
Just like we did in the previous guide <a href="FILE_SRC/ExploreScratchGPIO-PiStopFirstSteps.FILE_SRC_EXT">**Explore and Challenge Scratch GPIO: Pi-Stop First Steps**</a>
--->
<!---#else--->
...
<!---#ifdef ALT_LINK--->
<!---
*Hint: See the next guide (<a href="FILE_SRC/ExploreScratchGPIO-PiStopReactionGame.FILE_SRC_EXT">**Explore and Challenge Scratch GPIO: Pi-Stop Reaction Game**</a> which makes use of random delays.*
--->
<!---#else--->
